...
class Eff_GAT(nn.Module):
    ...
    def __init__(self, steps) -> None:
        ...
        self.combined_features_dim = 448 + 16 + 16
        ...
        self.time_emb = nn.Embedding(steps, 16)
        self.pos_mlp = nn.Sequential(nn.Linear(2, 32), nn.GELU(), nn.Linear(32, 16))
        self.mlp = nn.Sequential(
            nn.Linear(self.combined_features_dim, 64),
            nn.GELU(),
            nn.Linear(64, self.combined_features_dim),
        )
